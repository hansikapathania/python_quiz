questions = (
    ...
    "Q11. What is the correct file extension for Python files?",
    "Q12. Which function is used to get user input in Python?"
)
...
answers = ('B','C','B','C','C','B','B','C','C','C','C','A')
...
if len(guesses) != 0:
    print("\nYour Score:", (score / len(guesses)) * 100, "%")
else:
